...
const reasons = [
  ...
  'Modern Helicopters',
  'Our friendly staff and personable pilots will go out of their way to make sure you feel comfortable and have fun throughout the entire flight.',
  'There is No Language Barrier',
  'Having given New York City helicopter tours for years we understand that the city is a true melting pot of cultures. This is why we are proud to offer tours in multiple languages',
];
const languages = [
  'English',
  'Korean',
...
const AboutUs = () => {
  ...
  const aboutUsInfoSectionOne = () => (
    <div className="about-us-info-section-container">
      ...
      <p className="about-us-description">
        Serving both tourists and locals since 2006, we were recently awarded
        the TripAdvisor Certificate of Excellence. This means you, our
        customers, wrote wonderful reviews to make us a top-rated company. As a
        locally-owned company, we have a true understanding of New York City
        itself and are committed to making sure you learn its history while
        creating a life-long memory.
      </p>
    </div>
  );
  ...
  const aboutUsInfoSectionTwo = () => (
    <div className="about-us-info-section-container">
      <h3 className="about-us-title">
        There are a host of reasons to trust us as the premium source of
      ...
      <p className="about-us-description">
        Moreover, as part of our dedicated, top-of-the-line customer service, we
        will always take into consideration customers who have never flown in a
        helicopter. We understand that your first time may make you slightly
        nervous, which is why our friendly staff and personable pilots will go
        out of their way to make sure you feel comfortable and at ease
  ...
  const aboutUsInfoSectionThree = () => (
    <div className="about-us-info-section-container">
      ...
      <p className="about-us-description">
        Having given New York City helicopter tours for years, we understand
        that the city is a true melting pot of cultures. This is why we are
        proud to offer tours in multiple languages.
      </p>
      ...
      <p className="about-us-description">
        Trust your helicopter experience to us! Be sure to call us today at
        212-845-9822 or 866-592-9655 to get more information on your exciting
        helicopter tour.
      </p>
      <p className="about-us-description">
        Trust your helicopter experience to us!
      </p>
    </div>
  );
    ...
    <div className="crew-staff-container">
      <div className="grid-item-1">
        ...
        {captains.map((captain, index) => (
          <h5 key={index} className="crew-li">
            Captain: {captain}
          </h5>
        ))}
      </div>
    ...
    <main className="page-container">
      <TopImageSection
        title={
          <FormattedMessage
            id="about-us.title"
            defaultMessage="About Jet Air Blue Planes"
          />
        }
      />
