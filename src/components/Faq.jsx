...
const Faq = () => {
    ...
    return (
      <>
        {textArray.map((item, index) => (
          <span key={index}>
            {item}
            {(index !== textArray.length - 1 && bolded) && (
              <b>{bolded}</b>
            )}
  ...
  const faqInfo = (
    <div>
      <h3 className='faq-info-title'>faq</h3>
  ...
  const faqContactUsForm = (
    <form className='faq-contact-us-form'>
      <h3 className='contact-us-form-title'>Still Have Questions?</h3>
      <div className='contact-us-input-container'>
        <label htmlFor='name' className='contact-us-input-label'>Name</label>
        <input type='text' id='name' name='name' className='contact-us-input' />
      </div>
      <div className='contact-us-input-container'>
        <label htmlFor='email' className='contact-us-input-label'>Email</label>
        <input type='email' id='email' name='email' className='contact-us-input' />
      </div>
      <div className='contact-us-input-container'>
        <label htmlFor='phone' className='contact-us-input-label'>Phone</label>
        <input type='tel' id='phone' name='phone' className='contact-us-input' />
      </div>
      <div className='contact-us-input-container'>
        <label htmlFor='message' className='contact-us-input-label'>Message</label>
        <textarea id='textarea' name='message' rows='10' className='contact-us-textarea' />
      </div>
  ...
  return (
    <main className='page-container'>
      <TopImageSection title='Frequently Asked Questions' />
