...
const tour = {
  ...
  duration: '60 Minutes',
  availability: '4 Passenger Minimum, Monday-Sunday 10:00am-5:00pm',
  description: [
    'All aboard the most spectacular and unforgettable experience of your New York visit! With the extended route and approximately 60-minute duration, you’ll be sure to feel like a VIP on the VIP Tour!',
...
const relatedTours = [
  {
    ...
    description:
      'Take a flight that you will remember for a lifetime! Departing from the Republic Airport (Farmingdale, LI), the Classic Manhattan Tour begins at the majestic the Statue of Liberty, followed by the world-famous Manhattan Skyline.',
    image: ClassicManhattanCard,
  },
  {
    title: 'Deluxe Manhattan Plane Tour',
    description:
      'An exciting and comprehensive airplane tour of New York City with breathtaking views and excellent photo opportunities! This extended version of the Classic Tour will treat you to the best views of New York City including the Statue of Liberty, Empire State Building and Central park.',
    ...
    <div className="tour-info-section-container">
      ...
      <div className="tour-info-section-sighting-description-container">
        {description.map((paragraph, index) => (
          <p
            className="tour-info-section-sighting-description"
            key={index}
          >{`${paragraph}`}</p>
        ))}
      </div>
